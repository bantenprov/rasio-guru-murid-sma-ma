    ...
    <div class="row">
      <div class="col-lg-6 mb-3">
        <div class="card h-100" style="color: #fff; background-color: #2196F3;">
          <div class="card-body">
            <rasio-guru-murid-sma-ma-bar-03></rasio-guru-murid-sma-ma-bar-03>
          </div><!-- /.card-body -->
        </div><!-- /.card -->
      </div><!-- /col -->
      <div class="col-lg-6 mb-3">
        <div class="card h-100" style="color: #fff; background-color: #4CAF50;">
          <div class="card-body">
            <rasio-guru-murid-sma-ma-pie-03></rasio-guru-murid-sma-ma-pie-03>
          </div><!-- /.card-body -->
        </div><!-- /.card -->
      </div><!-- /col -->
    </div><!-- /.row -->
    ...
    <div class="row">
      ...
      <div class="col-lg-6 mb-3">
        <div class="card text-white bg-dark h-100">
          ...
          <div class="card-body">
            <rasio-guru-murid-sma-ma-bar-02></rasio-guru-murid-sma-ma-bar-02>
          </div><!-- /.card-body -->
        </div><!-- /.card -->
      </div><!-- /col -->
    </div><!-- /.row -->
