...
miniToastr.init();
export default {
    name: "rasio-guru-murid-sma-ma_add",
    components: {
        Datepicker
    },
    data() {
        return {
            rasio-guru-murid-sma-mas: [],
            provinces: [],
            regencies: {},
            formstate: {},
            model: {
    ...
    methods: {
        ...
        onSubmit: function() {
            if (this.formstate.$invalid) {
              ...
              {
                axios.post("/rasio-guru-murid-sma-ma/store", {
                ...
                .then(response => {
                  if(response.data.type == 'success'){
                    ...
                    window.location.href = '#/admin/rasio-guru-murid-sma-ma/'+response.data.id
                  }
                  else{
                    miniToastr.error(response.data.message, response.data.title)
                    window.location.href = '#/admin/rasio-guru-murid-sma-ma/create'
                  }
                },
                window.location.href = '#/admin/rasio-guru-murid-sma-ma/create')
        ...
        back() {
            window.location = '#/admin/rasio-guru-murid-sma-ma';
        }
    },
    mounted: function() {
        axios.get("/rasio-guru-murid-sma-ma/create").then(response => {
